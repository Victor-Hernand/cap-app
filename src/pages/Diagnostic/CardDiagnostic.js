        ...
        <>
            {loading ? (
                ...
                <div className="pl-3 mt-4 grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 bg-slate-50">
                    ...
                    {data.map((item, idx) => {
                        return (
                            <Link key={idx} to={`/diagnostic/show/${item.id}`}>
                                <div  className="bg-white max-w-sm rounded overflow-hidden shadow-lg my-2 mr-2">
                                    ...
                                    <div className="px-6 pt-4 pb-2">
                                        ...
                                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Fecha: {item.exam_date}</span>
                                    </div>
                                </div>
                            </Link>
